...
class ordered_array {
 public:
  ...
  using const_iterator =
      typename std::array<value_type, Length>::const_iterator;
  using reverse_iterator =
      typename std::array<value_type, Length>::reverse_iterator;
  using const_reverse_iterator =
      typename std::array<value_type, Length>::const_reverse_iterator;
  ...
  void insert(const Key& key, const Value& value) {
    ...
    auto pos = std::lower_bound(
        data_.begin(), data_.begin() + size_, key,
  ...
  Value& operator[](const Key& key) {
    ...
    std::move_backward(insert_pos, data_.begin() + size_,
                       data_.begin() + size_ + 1);
