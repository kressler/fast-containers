...
static void BM_OrderedArray_RemoveInsert(benchmark::State& state) {
  ...
  dense_map<int, int, Size, std::less<int>, search_mode> arr;
...
// Additional remove+insert benchmarks for larger array sizes
BENCHMARK(BM_OrderedArray_RemoveInsert<128, SearchMode::Binary>);
